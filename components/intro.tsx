...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Chhoeurn Kimla.</span> I'm a{" "}
        <span className="font-bold">
          full-stack developer and UX/UI Designer.
        </span>
        {" "}I enjoy building <span className="italic">sites & apps</span>. My focus
        is <span className="underline">React (Next.js) and Laravel</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="/Chhoeurn Kimla - Full-Stack Developer.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/kimla-chhoeurn-245642334/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
